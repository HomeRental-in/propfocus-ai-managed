...
The **managed package** installs Apex, LWCs, permission set *definitions*, External/Named Credential skeletons, and default CMDT. These subscriber-owned items should go through your deployment pipeline (not ad-hoc clicks in production):
